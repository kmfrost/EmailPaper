...
Full graph hubs                              & Social       & 0.589  \\
Partial graph communicability centrality     & Social       & 0.554  \\
PG communicability betweenness centrality    & Social       & 0.554  \\
Number of emails received as CC              & Traffic      & 0.507  \\
Percentage of emails received as forwards    & Traffic      & 0.503  \\
Partial graph degree centrality              & Social       & 0.492  \\
Partial graph pagerank                       & Social       & 0.492  \\
PG current flow closeness centrality         & Social       & 0.492  \\
Average number of emails received per day    & Traffic      & 0.489  \\
Average total emails per day                 & Traffic      & 0.479  \\
Partial graph average shortest paths         & Social       & 0.476  \\
Partial graph closeness centrality           & Social       & 0.476  \\
