...
In the case of project managers, the organic and official hierarchys more closely match.
...
These results demonstrate the difference between an organic organiziational chart and the official corporate hierarchy.
The email data was also used to show that emails could be used to predict an employee's primary program manager with $92\%$ accuracy.
It has a worse chance, $52.63\%$, of being able to identify the director associated with the employee on the official organizational chart.
