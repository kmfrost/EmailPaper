...
The result is an organic organization chart which contains much fuller understanding of the center's internal structure than can be found in the official organization chart.
\end{abstract}
...
However, email text contains very sensitive information and is often unavailable for a general email study.
...
Whereas there social features aim to quantify relationships within the community structure of the organization.
...
Utilizing the timestamp information, the total number of emails sent and received after hours and the number of emails sent and received after hours within the center were also used as metrics.
...
\begin{figure}[t]
    ...
    \vspace{-17pt}
	\caption{Project organization chart generated from the email data. This analysis could be used in corporate merges or restructuring in order to better understand the communication network of an organization.}
	\vspace{-18pt}
	\label{fig:org_chart}
\end{figure}
