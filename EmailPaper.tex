...
\begin{table}[H]
\centering
\caption{Comparing our databse to the Enron email corpus.  Our internal database is more modern, has more emails, and covers a longer time peroid.  However, it is comprised of less people than the Enron dataset.}
\label{tab:db_stats}
...
\multicolumn{1}{|l|}{Number of Participants}    & 32              & 149           &  &  \\
\multicolumn{1}{|l|}{Number of Distinct Emails} & 585,096         & 252,759       &  &  \\ \cline{1-3}
\end{tabular}
\end{table}
